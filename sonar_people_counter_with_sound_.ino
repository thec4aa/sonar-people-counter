...
void ringBell() {
  ...
  // // (move servo the other direction)
  Servo1.write(0);
  // delay(200);
  // Servo1.write(30); // go back to "home"


  // use millis to replace delay - failed
...
void loop() {
  ...
  if (IN1 < triggerDistance && IN1 > 1) {
    ...
    */
    ...
    Servo1.write(30); // move motor to "home" place
  }
